...
//which renders the graphics for each face
...
//        canvas.drawText("id: " + mFaceId, x + ID_X_OFFSET, y + ID_Y_OFFSET, mIdPaint);
        ...
        if(((face.getIsRightEyeOpenProbability()<0.2) && (face.getIsRightEyeOpenProbability()> -1.0))&&((face.getIsLeftEyeOpenProbability()<0.2)&& (face.getIsLeftEyeOpenProbability()>-1.0))) {
